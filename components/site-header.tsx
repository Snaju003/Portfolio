  ...
  useEffect(() => {
    ...
    const onScroll = () => {
      ...
      const distanceFromBottom =
        document.documentElement.scrollHeight - scrollTop - viewportHeight;
      ...
      ids.forEach((id, index) => {
        ...
        if (isNearBottom) {
          ...
          sectionProgress = Math.min(1, scrolledIntoSection / elementHeight);
        }
          ...
          >
            <span
              ...
              style={{
                ...
                transition: reduced ? "none" : "background 300ms ease",
              }}
            />
            <span
              ...
              >
                <div className='border-b bg-neutral-900/70 text-emerald-200'>
                  <div className='flex items-center gap-2 px-4 py-3 border-b border-emerald-700/30'>
                    ...
                    <span className='ml-2 text-xs'>menu • terminal</span>
                  </div>
                ...
                <div className='px-4 py-4 font-mono'>
                    ...
                    <nav className='grid gap-2'>
                      {navLinks.map((item) => {
                        ...
                        return (
                          ...
                          >
                            <ProgressDot href={item.href} label={item.label} />
                  ...
                  <Button asChild className='w-full mb-3'>
                    <a href='/Soumya_Raj_Sarkar_Resume__Web_.pdf' download>
                      Download Resume
                    </a>
                  </Button>
                </div>
            ...
            <TooltipProvider>
              <NavigationMenu>
                <NavigationMenuList className='flex justify-center gap-1'>
                  {navLinks.map((item) => {
                    const isActive = active === item.href;
                    const pct = Math.round((sectionProg[item.href] ?? 0) * 100);
                    return (
